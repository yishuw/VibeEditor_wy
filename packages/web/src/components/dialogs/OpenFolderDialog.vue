<template>
  <div class="dialog-overlay" @click.self="$emit('cancel')">
    <div class="dialog open-folder-dialog">
      <h3 class="dialog-title">{{ $t('openDialog.selectFolder') }}</h3>

      <div class="dialog-toolbar">
        <button class="toolbar-btn" :disabled="!selectedPath" @click="startNewFolder">
          📁+ {{ $t('openDialog.newFolder') }}
        </button>
        <button class="toolbar-btn" :disabled="!selectedPath" @click="goToParent">
